...
describe("ConfigHelper Test Suite", () => {
    ...
    describe("getPluginBySearchAndReplace", () => {
        test("should perform expected behavior", () => {
            const value = ConfigHelper.getPluginBySearchAndReplace(mockTarget, "%content%");
    ...
    describe("getAttributeFormatBySearchAndReplace", () => {
        test("should perform expected behavior", () => {
            const value = ConfigHelper.getAttributeFormatBySearchAndReplace(mockTarget, "%content%");
