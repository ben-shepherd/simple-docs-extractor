...
export type ExtractorPluginConstructor = new (...args: unknown[]) => ExtractorPlugin;

export type BaseExtractorConfig = Record<string, unknown> & {
    searchAndReplace: string;
};

export type ExtractorPlugin<Config extends BaseExtractorConfig = BaseExtractorConfig> = {
